...
public class App {
	public static void main(String[] args) {
		...
		//controles
		new Camera(tela.getFase(), fase.getPersonagem(), fase.getItemManager(), fase.getMapaChao(),fase.getMapaColisao());
		...
		new EventoBotoes(tela.getMenu(), tela, tela.getInventario());
